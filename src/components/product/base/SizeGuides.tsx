    ...
    return (
        <Drawer.Root
            ...
            <Drawer.Portal>
                ...
                <Drawer.Content className={cn('fixed z-30 outline-none', isMobile
                    ? "inset-x-0 bottom-0 mt-24 flex flex-col max-h-[98%] h-full"
                    : "inset-0 my-16 flex items-center justify-center")}
                >
                    <div ref={contentRef} className={cn("w-full h-full relative flex flex-col p-3 max-w-3xl mx-auto bg-background", isMobile ? 'rounded-t-2xl' : 'rounded-2xl pt-5')}>
                        {isMobile
